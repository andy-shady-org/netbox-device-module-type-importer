...
from netbox_device_module_type_importer.tables import MetaModuleTypeTable
from netbox_device_module_type_importer.filtersets import MetaModuleTypeFilterSet
from netbox_device_module_type_importer.forms import MetaModuleTypeFilterForm
...
class MetaModuleTypeListView(generic.ObjectListView):
    ...
    actions = (BulkDelete,)
    template_name = "netbox_device_module_type_importer/metamoduletype_list.html"
...
class MetaModuleTypeEditView(generic.ObjectEditView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if token:
            ...
            return redirect(
                "plugins:netbox_device_module_type_importer:metamoduletype_list"
            )
        try:
