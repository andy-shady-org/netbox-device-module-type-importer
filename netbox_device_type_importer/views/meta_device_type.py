...
from netbox_device_type_importer.tables import MetaDeviceTypeTable
from netbox_device_type_importer.filtersets import MetaDeviceTypeFilterSet
from netbox_device_type_importer.forms import MetaDeviceTypeFilterForm
...
class MetaDeviceTypeListView(generic.ObjectListView):
    ...
    actions = (BulkDelete,)
    template_name = "netbox_device_type_importer/metadevicetype_list.html"
...
class MetaDeviceTypeEditView(ContentTypePermissionRequiredMixin, View):
    ...
    def post(self, request):
        ...
        created = 0
        updated = 0
        if not request.user.has_perm("netbox_device_type_importer.add_metadevicetype"):
...
class MetaDeviceTypeImportView(ContentTypePermissionRequiredMixin, View):
    ...
    def get_required_permission(self):
        return "netbox_device_type_importer.add_metadevicetype"
