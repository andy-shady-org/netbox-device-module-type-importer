...
class DeviceTypeImporterConfig(PluginConfig):
    name = "netbox_device_type_importer"
    verbose_name = _("Device Type Importer")
    description = _("Import DeviceTypes from github repo")
    version = __version__
    author = "Andy Wilson"
    author_email = "andy@shady.org"
    base_url = "netbox-device-type-importer"
    required_settings = []
    min_version = "4.5.0"
    default_settings = {
